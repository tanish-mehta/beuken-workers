...
declare namespace Cloudflare {
	interface Env {
		...
		AI_GENERATION_URL:
			| 'https://vercel-api.example.com/generate-charm'
			| 'https://your-production-ai-api.com/generate-charm'
			| 'https://your-staging-ai-api.com/generate-charm';
		SUPABASE_URL:
		...
		SHOPIFY_STORE_URL:
			...
			| 'https://your-staging-store.myshopify.com';
